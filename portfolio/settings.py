...
# Remplacer la base de données par celle de Heroku
...
EMAIL_HOST_USER = 'kenechy0@gmail.com'  # Votre adresse Gmail
EMAIL_HOST_PASSWORD = 'okjf cftq otbd nbxr'  # Votre mot de passe Gmail ou un mot de passe d'application
